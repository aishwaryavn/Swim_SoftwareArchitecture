...
from SWIM_Analyzer import Analyzer
from SWIM_Knowledge import Knowledge

rl_obj = Reinforcer()

knowledge_obj = Knowledge()

# This is responsible for continuously fetching data from the SWIM simulator
        ...
        while (1):
            if (new_time - start_time).seconds >= 60:
                try:
                    ...
                    analyzer_obj.perform_analysis(monitor_dict,conn,rl_obj) # This will pass the control to the next class
